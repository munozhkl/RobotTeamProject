...
def main():
    ...
    pokemon_label = ttk.Label(main_frame, text = 'POKEMON', font =('Verdana', 30))
    ...
    right_speed_entry.grid(row=2, column=0)
    ...
    arm_up_button.grid(row=6, column=0)
    ...
    arm_down_button.grid(row=7, column=0)
