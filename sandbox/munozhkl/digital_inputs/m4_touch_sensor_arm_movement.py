...
def main():
    ...
    while True:
        ...
        if command_to_run == 'c':
            ...
            #print(" 3 is to delete this print statement, uncomment the line below, and implement that function.")
            arm_calibration(arm_motor, touch_sensor)
        elif command_to_run == 'u':
            print("Move the arm to the up position")
            #print(" 4 is to delete this print statement, uncomment the line below, and implement that function.")
            arm_up(arm_motor, touch_sensor)
        elif command_to_run == 'd':
            print("Move the arm to the down position")
            #print(" 5 is to delete this print statement, uncomment the line below, and implement that function.")
            arm_down(arm_motor)
