...
Authors: David Fisher and KAthi Munoz.
...
def main():
    ...
    my_name = "Kathi"  # Used to set the topic that you are *subscribed to* listen to
    team_member_name = "Maddie"  # Used to set the topic that you will *publish to*
