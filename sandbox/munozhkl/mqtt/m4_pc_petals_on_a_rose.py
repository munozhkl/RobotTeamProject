...
# DONETODO: 3. Create a method named guess_response within MyDelegate.
...
def main():
    ...
    mqtt_client = com.MqttClient(my_delegate) # Create an mqtt_client object from the com.MqttClient class passing in my_delegate
    mqtt_client.connect_to_ev3() # connect_to_ev3
