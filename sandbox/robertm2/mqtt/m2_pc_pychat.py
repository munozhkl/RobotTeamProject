...
Authors: David Fisher and Madison Robertson.
...
def main():
    ...
    my_name = "Maddie"  # Used to set the topic that you are *subscribed to* listen to
    team_member_name = "Kathi"  # Used to set the topic that you will *publish to*
